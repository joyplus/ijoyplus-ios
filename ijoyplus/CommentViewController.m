...
- (void)viewDidLoad
{
	...
	commentListViewController = [[CommentListViewController alloc]initWithNibName:@"CommentListViewController" bundle:nil];
    [self.view addSubview:commentListViewController.tableView];
    [self addChildViewController:commentListViewController];
