...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(cell == nil){
        ...
        for(int i = 0; i < num; i++){
            ...
            if(i == 0){
                imageView.frame = CGRectMake(MOVIE_LOGO_WIDTH_GAP, 0, MOVIE_LOGO_WIDTH, VIDEO_LOGO_HEIGHT);
                titleLabel.frame = CGRectMake(MOVIE_LOGO_WIDTH_GAP, VIDEO_LOGO_HEIGHT, MOVE_NAME_LABEL_WIDTH, MOVE_NAME_LABEL_HEIGHT);
            } else if(i == 1){
                imageView.frame = CGRectMake(MOVIE_LOGO_WIDTH + MOVIE_LOGO_WIDTH_GAP*1.5, 0, MOVIE_LOGO_WIDTH, VIDEO_LOGO_HEIGHT);
                titleLabel.frame = CGRectMake(MOVIE_LOGO_WIDTH + MOVIE_LOGO_WIDTH_GAP*1.5, VIDEO_LOGO_HEIGHT, MOVE_NAME_LABEL_WIDTH, MOVE_NAME_LABEL_HEIGHT);
            } else {
                imageView.frame = CGRectMake(MOVIE_LOGO_WIDTH*2 + MOVIE_LOGO_WIDTH_GAP*2, 0, MOVIE_LOGO_WIDTH, VIDEO_LOGO_HEIGHT);
                titleLabel.frame = CGRectMake(MOVIE_LOGO_WIDTH*2 + MOVIE_LOGO_WIDTH_GAP*2, VIDEO_LOGO_HEIGHT, MOVE_NAME_LABEL_WIDTH, MOVE_NAME_LABEL_HEIGHT);
            }
