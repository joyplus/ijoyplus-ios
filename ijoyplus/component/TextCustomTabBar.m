...
@interface TextCustomTabBar (PrivateMethods)
...
@implementation TextCustomTabBar
@synthesize buttons;
...
//  UIImage* buttonPressedImage = [self tabBarImage:rawButtonImage size:button.frame.size backgroundImage:[delegate selectedItemBackgroundImage]];
  ...
  title.center = CGPointMake(button.center.x, self.frame.size.height/2);
