 ...
 */
- (TencentLoginView *)authorizeWithTencentAppAuthInSafari:(BOOL) bInSafari{
...
- (TencentLoginView *)authorize:(NSArray *)permissions inSafari:(BOOL)bInSafari {
	return [self authorize:permissions
		 localAppId:nil
		   inSafari:bInSafari];
}


- (TencentLoginView *)authorize:(NSArray *)permissions
	localAppId:(NSString *)localAppId
		 inSafari:(BOOL)bInSafari{
	self.localAppId = localAppId;
	self.permissions = permissions;
	
	TencentLoginView *view = [self authorizeWithTencentAppAuthInSafari:bInSafari];
    return view;
}
