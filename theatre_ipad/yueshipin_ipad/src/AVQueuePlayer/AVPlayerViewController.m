...
-(void)showTrackSelectButton{
        ...
        [trackSelect setBackgroundImage:[UIImage imageNamed:@"ipad_shengdao.png"] forState:UIControlStateNormal];
        [trackSelect setBackgroundImage:[UIImage imageNamed:@"ipad_shengdao_s.png"] forState:UIControlStateHighlighted];
        [trackSelect setBackgroundImage:[UIImage imageNamed:@"ipad_shengdao_s.png"] forState:UIControlStateSelected];
