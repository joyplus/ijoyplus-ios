...
@interface LeftRightScrollView ()

@property (nonatomic, strong)RemoteAction *tpdragAction;
@end

@implementation LeftRightScrollView
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    [action trigger];
    RemoteAction *scrollAction = [ActionFactory getSimpleActionByEvent:LEFT_AND_RIGHT_SCROLL_MODE];
