...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(cell == nil){
        ...
        for (int i = 0; i < 3; i++) {
            ...
            [imageBtn setFrame:CGRectMake(93 * i + (i+1)*10, 10, 93, 93)];
            [imageBtn setBackgroundImage:[UIImage imageNamed:@"list_default"] forState:UIControlStateNormal];
            [imageBtn setBackgroundImage:[UIImage imageNamed:@"list_active"] forState:UIControlStateHighlighted];
            ...
            UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(93 * i + (i+1)*10 + 4, 14, 93 - 8, 93 - 8)];
