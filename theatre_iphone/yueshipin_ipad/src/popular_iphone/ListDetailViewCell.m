...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.imageview = [[UIImageView alloc] initWithFrame:CGRectMake(16, 18, 54, 82)];
       ...
       // [support_ setBackgroundImage:[UIImage imageNamed:@"collect_number.png"] forState:UIControlStateDisabled];
        ...
        score_.textColor = [UIColor colorWithRed:247/255.0 green:122/255.0 blue:151/255.0 alpha:1];
