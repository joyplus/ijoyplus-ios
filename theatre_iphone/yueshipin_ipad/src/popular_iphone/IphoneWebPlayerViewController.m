...
- (void)updateWatchRecord
{
    ...
    NSString *subname = nil; /*[NSString stringWithFormat:@"%d",(playNum+1)];*/
    if (nil == subnameArray)
    {
        subnameArray = [[NSMutableArray alloc] init];
    }
    ...
    NSDictionary *parameters = [NSDictionary dictionaryWithObjectsAndKeys: userId, @"userid", prodId_, @"prod_id", nameStr_, @"prod_name", subname, @"prod_subname", [NSNumber numberWithInt:videoType_], @"prod_type", tempPlayType, @"play_type",playBackTime, @"playback_time", [NSNumber numberWithInt:0], @"duration", webUrl_, @"video_url", nil];
