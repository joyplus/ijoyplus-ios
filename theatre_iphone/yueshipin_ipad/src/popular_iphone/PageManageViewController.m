...
//    self.navigationItem.rightBarButtonItem = rightButtonItem;
    ...
    self.scrollView.contentSize = CGSizeMake(320*PAGE_NUM, kCurrentWindowHeight-88-37);
    ...
    self.tvTableList = [[UITableView alloc] initWithFrame:CGRectMake(320, 0,320 , kCurrentWindowHeight-125) style:UITableViewStylePlain];
    ...
    self.movieTableList = [[UITableView alloc] initWithFrame:CGRectMake(0, 0,320 , kCurrentWindowHeight-125) style:UITableViewStylePlain];
    ...
    self.showTableList = [[UITableView alloc] initWithFrame:CGRectMake(960, 0,320 , kCurrentWindowHeight-125) style:UITableViewStylePlain];
    ...
    self.comicTableList = [[UITableView alloc] initWithFrame:CGRectMake(640, 0,320 , kCurrentWindowHeight-125) style:UITableViewStylePlain];
