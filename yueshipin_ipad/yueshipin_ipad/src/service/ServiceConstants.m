...
NSString *const kPathTops = @"/joyplus-service/index.php/tops";
NSString *const kPathSupport = @"/joyplus-service/index.php/program/support";
NSString *const kPathUserSupport = @"/joyplus-service/index.php/user/supports";
...
NSString *const kPathGenerateUIID = @"/joyplus-service/index.php/account/generateUIID";
NSString *const kPathTopItems = @"/joyplus-service/index.php/top_items";
...
NSString *const KPathCheckBinding = @"/joyplus-service/index.php/program/check_binding";
