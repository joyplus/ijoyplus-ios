...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(cell == nil){
        ...
        UILabel *dingNumberLabel = [[UILabel alloc]initWithFrame:CGRectMake(130, 125, 40, 24)];
        ...
        UILabel *collectionNumberLabel = [[UILabel alloc]initWithFrame:CGRectMake(220, 126, 40, 24)];
