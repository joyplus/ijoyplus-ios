...
//    _toolbar.barStyle					= UIBarStyleBlackTranslucent;
    ...
    _caption.textColor							= [UIColor clearColor];
    _caption.backgroundColor					= [UIColor whiteColor];
...
- (void)playBtnClicked
{
    [AppDelegate instance].castingType = YueImageCasting;
    [AppDelegate instance].displayingImageIndex = _currentIndex;
    [AppDelegate instance].imageObjectArray = mediaObjectArray;
}
